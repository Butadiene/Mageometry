#!/usr/bin/env python3
"""
Regenerate fig11 with extended X range (-20 to 5 Re) - Optimized version
"""
...
print("="*80)
print("REGENERATING FIGURE 11 (OPTIMIZED)")
print("="*80)
...
x_grid = np.linspace(-20, 5, 51)  # 51 points for 25 Re span
y_grid = np.linspace(-12, 12, 49)  # 49 points for 24 Re span
...
for row_idx, (params, condition) in enumerate(param_sets):
    ...
    for col_idx, z_height in enumerate(z_heights):
        ...
        print(f"  Z={z_height}: {scatter_frac:.1f}%")
...
print("\nFigure 11 regenerated successfully with extended X range (-20 to 5 Re)!")