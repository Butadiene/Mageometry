#!/usr/bin/env python3
"""
Regenerate only fig11 from magnetic_field_parameter_variations.py
"""
...
def create_fig5_variations():
    """Create XY plane slices with different model parameters"""
    ...
    # Create XY grid with extended X range
    x_grid = np.linspace(-20, 5, 76)  # Extended from -15 to -20, reduced resolution
    ...
    for row_idx, (params, condition) in enumerate(param_sets):
        ...
        for col_idx, z_height in enumerate(z_heights):
            ...
            print(f"  {condition}, Z={z_height}: {scatter_frac:.1f}%")
...
if __name__ == "__main__":
    ...
    print("\nFigure 11 regenerated successfully!")