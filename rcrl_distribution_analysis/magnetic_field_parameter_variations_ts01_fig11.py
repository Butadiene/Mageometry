#!/usr/bin/env python3
"""
Magnetic Field Parameter Variations using Ts01 Model - Figure 11 only
...
print("="*80)
print("CREATING FIGURE 11 - TS01 MODEL")
print("="*80)
...
def create_fig11_simplified():
    """Create XY plane slices with different model parameters - simplified version"""
    ...
    # Create smaller XY grid for faster computation
    x_grid = np.linspace(-15, 5, 81)  # Reduced from -20 to -15 and fewer points
    y_grid = np.linspace(-10, 10, 81)  # Fewer points
...
if __name__ == "__main__":
    create_fig11_simplified()
    
    print("\n" + "="*80)
    print("FIGURE 11 COMPLETE (Ts01)")
    print("="*80)