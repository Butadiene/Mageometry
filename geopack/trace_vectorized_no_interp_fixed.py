...
FIXED VERSION: Boundary check now happens BEFORE the step, matching scalar implementation.
"""
...
def trace_vectorized_no_interp_fixed(xi, yi, zi, dir=1, rlim=10, r0=1, parmod=2,
